...
<html lang="es">
  <head>
    ...
    <meta charset="UTF-8">
     ...
     <!-- Enlaces de objectos controladores -->
     <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-+0n0xVW2eSR5OomGNYDnhzAbDsOXxcvSN1TPprVMTNDbiYZCxYbOOl7+AMvyTG2x" crossorigin="anonymous">  
          ...
          <ul>
              ...
              <div id="collapseOne" class="collapse" aria-labelledby="headingOne">
                <div>
                  <ul>
                    ...
                    <li><a href="#">Perfiles Administrativos</a></li>
                    <li><a href="../../content/view_students.php">Perfiles Estudiantiles</a></li>
                  </ul>
                </div>
              </div>
            </li>
            ...
            <li class="accordion">
              <a href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="collapsible">
                <span class="icon-pie-chart mr-3"></span>Estadisticas
              </a>

              <div id="collapseTwo" class="collapse" aria-labelledby="headingOne">
                <div>
                  <ul>
                    <li><a href="#">Estadísticas de uso</a></li>
                    <li><a href="#">Estadisticas de registro</a></li>
                    <li><a href="#">Estadísticas por características</a></li>
                    <li><a href="#">Estadísticas por áreas</a></li>
                  </ul>
                </div>
              </div>
            </li>
            ...
            <li class="accordion">
              ...
              <div id="collapsefour" class="collapse" aria-labelledby="headingOne">
                <div>
                  <ul>
                    <li><a href="../../content/more_area.php">Añadir área</a></li>
                    <li><a href="../../content/more_person.php">Añadir Personal</a></li>
                  </ul>
                </div>
              </div>
            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text">
                                   ...
                                   <h1 class="text-white" data-aos="fade-up">Lo sentimos su cuenta no pudo ser tramitada</h1>
                                   <strong class="d-block py-1 pl-1 text-white" data-aos="fade-up" data-aos-delay="100">Por favor comuniquese con el equipo de desrrollo</strong>

                                   <a href="../../index.php" class="custom-btn btn-bg btn mt-3" data-aos="fade-up" data-aos-delay="100">Volver al inicio</a>
                              </div>
                        </div>
